...
Each "video" lesson carries a real YouTube URL matched to its specific topic
(not just the course's general subject) — found via web search and verified
individually against YouTube's oEmbed API on 2026-08-17 to confirm the video
exists, is publicly embeddable, and isn't age/login-gated.
"""
...
DEFAULT_COURSES = [
    {
        ...
        "lessons": [
            {"title": "Why prompts matter", "type": "video", "duration": 12, "body": "An overview of how language models interpret instructions, and why small wording changes produce very different results.", "video_url": "https://www.youtube.com/watch?v=8RWfE9eDWXI"},
            ...
            {"title": "Few-shot examples", "type": "video", "duration": 14, "body": "Showing the model examples of the input and output pattern you want is often more reliable than describing the rule in words.", "video_url": "https://www.youtube.com/watch?v=5GXX9buFMY0"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            ...
            {"title": "Linear regression from scratch", "type": "video", "duration": 18, "body": "How linear regression fits a line to data by minimizing squared error, with a worked example.", "video_url": "https://www.youtube.com/watch?v=7ArmBVF2dCs"},
            {"title": "Classification and accuracy", "type": "video", "duration": 16, "body": "Moving from predicting numbers to predicting categories, and why accuracy alone can be misleading.", "video_url": "https://www.youtube.com/watch?v=_G59OIZNaCs"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            {"title": "From neurons to networks", "type": "video", "duration": 15, "body": "How a single artificial neuron works, and how stacking them into layers lets a network learn complex patterns.", "video_url": "https://www.youtube.com/watch?v=aircAruvnKk"},
            ...
            {"title": "Training your first network", "type": "video", "duration": 22, "body": "A guided walkthrough training a small network to classify handwritten digits.", "video_url": "https://www.youtube.com/watch?v=UBaY7iya-ZY"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            ...
            {"title": "Word embeddings", "type": "video", "duration": 17, "body": "Representing words as vectors so that similar words end up close together in space.", "video_url": "https://www.youtube.com/watch?v=yVZTtnSkya8"},
            {"title": "Building a text classifier", "type": "video", "duration": 19, "body": "Combining embeddings with a simple classifier to label text, such as sentiment analysis.", "video_url": "https://www.youtube.com/watch?v=wKI5k6VgQwg"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            {"title": "How convolutions see images", "type": "video", "duration": 16, "body": "Convolutional filters slide over an image detecting edges, textures and shapes at increasing levels of abstraction.", "video_url": "https://www.youtube.com/watch?v=KuXjwB4LzSA"},
            ...
            {"title": "Object detection basics", "type": "video", "duration": 20, "body": "Detecting and localizing multiple objects in a single image, and the tradeoffs between speed and accuracy.", "video_url": "https://www.youtube.com/watch?v=6LOsCEs9IAc"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            ...
            {"title": "CI/CD for machine learning", "type": "video", "duration": 18, "body": "Automating tests and deployment for models, not just code, including data validation checks.", "video_url": "https://www.youtube.com/watch?v=pyJhQJgO8So"},
            {"title": "Monitoring and drift", "type": "video", "duration": 17, "body": "Detecting when a deployed model degrades because the real world has changed.", "video_url": "https://www.youtube.com/watch?v=EfkS2I7LKGo"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            {"title": "What generative AI can and cannot do", "type": "video", "duration": 11, "body": "A realistic look at current capabilities and common failure modes, so teams set the right expectations.", "video_url": "https://www.youtube.com/watch?v=qbP4tfSY33E"},
            ...
            {"title": "Shipping and iterating", "type": "video", "duration": 12, "body": "Launching with guardrails, collecting feedback, and iterating on prompts and UX together.", "video_url": "https://www.youtube.com/watch?v=2HNSG990Ew8"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            {"title": "Where bias comes from", "type": "video", "duration": 14, "body": "Bias can enter through training data, labeling decisions, or the objective a model is optimized for.", "video_url": "https://www.youtube.com/watch?v=4qSZEP5lJi4"},
            ...
            {"title": "Privacy by design", "type": "video", "duration": 13, "body": "Minimizing data collection and giving users control are easier to build in early than to retrofit.", "video_url": "https://www.youtube.com/watch?v=E1OoHUWbEjk"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            {"title": "Agents, states and rewards", "type": "video", "duration": 15, "body": "A reinforcement learning agent takes actions in an environment and learns from the rewards it receives.", "video_url": "https://www.youtube.com/watch?v=Z-T0iJEXiwM"},
            ...
            {"title": "Policies and value functions", "type": "video", "duration": 18, "body": "A policy maps states to actions; a value function estimates how good a state or action is in the long run.", "video_url": "https://www.youtube.com/watch?v=eMxOGwbdqKY"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            ...
            {"title": "Feature stores", "type": "video", "duration": 16, "body": "A feature store keeps features consistent between training and serving, avoiding subtle mismatches.", "video_url": "https://www.youtube.com/watch?v=DESBDukN9gw"},
            {"title": "Versioning data, not just code", "type": "video", "duration": 15, "body": "Reproducible experiments require tracking which dataset version produced which model.", "video_url": "https://www.youtube.com/watch?v=D_Ha_bNviHk"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            {"title": "Fine-tuning versus prompting", "type": "video", "duration": 14, "body": "Fine-tuning changes model weights; prompting only changes the instructions. Each fits different problems.", "video_url": "https://www.youtube.com/watch?v=VCYD1JqLqNs"},
            ...
            {"title": "Evaluating a fine-tuned model", "type": "video", "duration": 15, "body": "Comparing the fine-tuned model against the base model on held-out examples before shipping it.", "video_url": "https://www.youtube.com/watch?v=EwZJnMXxOZY"},
        ],
        "quiz": [
    ...
    },
    {
        ...
        "lessons": [
            {"title": "What makes something an agent", "type": "video", "duration": 13, "body": "An agent plans, acts, observes results and decides its next step, rather than answering in one shot.", "video_url": "https://www.youtube.com/watch?v=MKqg6wzOySA"},
            ...
            {"title": "Memory and multi-step tasks", "type": "video", "duration": 16, "body": "Persisting context across steps lets an agent complete tasks that take more than one action.", "video_url": "https://www.youtube.com/watch?v=hrciMR7e7Fk"},
        ],
        "quiz": [
